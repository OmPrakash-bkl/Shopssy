...
if(isset($_SERVER['REQUEST_METHOD'])) {
        ...
        $max_val_of_b_and_i_identification_id_query = "SELECT MAX(b_and_i_identification_id) AS `b_and_i_identification_id_count_val` FROM `brand_and_item_list` WHERE `subs_cat_identification_id_two` = $subs_cat_identification_id_two";
        $max_val_of_b_and_i_identification_id_result = mysqli_query($conn, $max_val_of_b_and_i_identification_id_query);
