...
if(isset($_SERVER['REQUEST_METHOD'])) {
    ...
    if(is_numeric($search_keyword)) {
        $require_data_query = "SELECT * FROM `filter_sub` WHERE `filter_sub_id` LIKE '%$search_keyword%';";
    } else {
     $require_data_query = "SELECT * FROM `filter_sub` WHERE `filter_datas` LIKE '%$search_keyword%';"; 
    }
